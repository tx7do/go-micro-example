...
type Server struct {
	...
	Micro         *Server_Micro          `protobuf:"bytes,8,opt,name=micro,proto3" json:"micro,omitempty"`         // micro服务
...
func (x *Server) GetMicro() *Server_Micro {
	if x != nil {
		return x.Micro
	}
	return nil
...
type Server_REST struct {
	...
	Network           string                 `protobuf:"bytes,2,opt,name=network,proto3" json:"network,omitempty"`                                                  // 网络
	Addr              string                 `protobuf:"bytes,3,opt,name=addr,proto3" json:"addr,omitempty"`                                                        // 服务监听地址
	Timeout           *durationpb.Duration   `protobuf:"bytes,4,opt,name=timeout,proto3" json:"timeout,omitempty"`                                                  // 超时时间
	Cors              *Server_REST_CORS      `protobuf:"bytes,5,opt,name=cors,proto3" json:"cors,omitempty"`                                                        // 服务监听地址
	Middleware        *Middleware            `protobuf:"bytes,6,opt,name=middleware,proto3" json:"middleware,omitempty"`                                            // 中间件
	EnableGrpcGateway bool                   `protobuf:"varint,10,opt,name=enable_grpc_gateway,json=enableGrpcGateway,proto3" json:"enable_grpc_gateway,omitempty"` // 是否启用gRPC-gateway，否则使用gin
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *Server_REST) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
func (x *Server_REST) GetEnableGrpcGateway() bool {
	if x != nil {
...
type Server_Websocket struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Enable        bool                   `protobuf:"varint,1,opt,name=enable,proto3" json:"enable,omitempty"`
	Network       string                 `protobuf:"bytes,2,opt,name=network,proto3" json:"network,omitempty"` // 网络样式：http、https
	Addr          string                 `protobuf:"bytes,3,opt,name=addr,proto3" json:"addr,omitempty"`       // 服务监听地址
...
func (x *Server_Websocket) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
type Server_Mqtt struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Enable        bool                   `protobuf:"varint,1,opt,name=enable,proto3" json:"enable,omitempty"`
	Addr          string                 `protobuf:"bytes,2,opt,name=addr,proto3" json:"addr,omitempty"` // 对端网络地址
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server_Mqtt) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
type Server_Kafka struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Enable        bool                   `protobuf:"varint,1,opt,name=enable,proto3" json:"enable,omitempty"`
	Addrs         []string               `protobuf:"bytes,2,rep,name=addrs,proto3" json:"addrs,omitempty"` // 对端网络地址
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server_Kafka) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
func (x *Server_RabbitMQ) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
type Server_SSE struct {
	...
	Codec         string                 `protobuf:"bytes,6,opt,name=codec,proto3" json:"codec,omitempty"`     // 编解码器
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Server_SSE) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
func (x *Server_Micro) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Micro) ProtoMessage() {}

func (x *Server_Micro) ProtoReflect() protoreflect.Message {
	mi := &file_common_conf_server_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Micro.ProtoReflect.Descriptor instead.
func (*Server_Micro) Descriptor() ([]byte, []int) {
	return file_common_conf_server_proto_rawDescGZIP(), []int{0, 7}
}

func (x *Server_Micro) GetEnable() bool {
	if x != nil {
		return x.Enable
	}
	return false
...
func (x *Server_Micro) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *Server_Micro) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Server_Micro) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *Server_Micro) GetMiddleware() *Middleware {
	if x != nil {
		return x.Middleware
	}
	return nil
...
func (x *Server_REST_CORS) Reset() {
	*x = Server_REST_CORS{}
	mi := &file_common_conf_server_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_common_conf_server_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8c, 0x0d, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x72, 0x76, 0x65, 0x72, 0x2e, 0x53, 0x53, 0x45, 0x52, 0x03, 0x73, 0x73, 0x65, 0x12, 0x2f, 0x0a,
	0x05, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x2e, 0x4d, 0x69, 0x63, 0x72, 0x6f, 0x52, 0x05, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x1a, 0xf3,
	0x02, 0x0a, 0x04, 0x52, 0x45, 0x53, 0x54, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x6e, 0x61, 0x62, 0x6c,
	...
	,
	...
	0x67, 0x69, 0x6e, 0x73, 0x1a, 0xba, 0x01, 0x0a, 0x04, 0x47, 0x52, 0x50, 0x43, 0x12, 0x16, 0x0a,
	...
	0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x12, 0x37, 0x0a, 0x0a, 0x6d, 0x69, 0x64, 0x64,
	0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x4d, 0x69, 0x64, 0x64, 0x6c,
	0x65, 0x77, 0x61, 0x72, 0x65, 0x52, 0x0a, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72,
	0x65, 0x1a, 0xb0, 0x01, 0x0a, 0x09, 0x57, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x12,
	...
	0x04, 0x61, 0x64, 0x64, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x64,
	0x65, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x63, 0x6f, 0x64, 0x65, 0x63, 0x12,
	...
	,
	...
	0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x64, 0x65, 0x63, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x63, 0x6f, 0x64, 0x65, 0x63, 0x1a, 0xbb, 0x01, 0x0a, 0x05, 0x4d, 0x69, 0x63, 0x72, 0x6f,
	...
	,
}
...
var file_common_conf_server_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_common_conf_server_proto_goTypes = []any{
	...
	(*Server_Micro)(nil),        // 8: common.conf.Server.Micro
	(*Server_REST_CORS)(nil),    // 9: common.conf.Server.REST.CORS
	(*durationpb.Duration)(nil), // 10: google.protobuf.Duration
	(*Middleware)(nil),          // 11: common.conf.Middleware
}
var file_common_conf_server_proto_depIdxs = []int32{
	...
	8,  // 7: common.conf.Server.micro:type_name -> common.conf.Server.Micro
	10, // 8: common.conf.Server.REST.timeout:type_name -> google.protobuf.Duration
	9,  // 9: common.conf.Server.REST.cors:type_name -> common.conf.Server.REST.CORS
	11, // 10: common.conf.Server.REST.middleware:type_name -> common.conf.Middleware
	10, // 11: common.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	11, // 12: common.conf.Server.GRPC.middleware:type_name -> common.conf.Middleware
	10, // 13: common.conf.Server.Websocket.timeout:type_name -> google.protobuf.Duration
	10, // 14: common.conf.Server.SSE.timeout:type_name -> google.protobuf.Duration
	10, // 15: common.conf.Server.Micro.timeout:type_name -> google.protobuf.Duration
	11, // 16: common.conf.Server.Micro.middleware:type_name -> common.conf.Middleware
